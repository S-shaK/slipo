        ...
        <div className="w-full max-w-sm">
          ...
          {inviteQ.data && (
            <div className="mb-4 rounded-md border border-accent/40 bg-accent/10 p-3 text-sm">
              You've been invited to join <span className="font-semibold">{inviteQ.data.manager_name}</span>'s team. Sign up with <span className="font-mono text-xs">{inviteQ.data.email}</span> to accept.
            </div>
          )}
